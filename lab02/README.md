...
Для перевірки коректності шифрування скористаємося сайтом Cryptii (рисунок 13). Слід зауважити, що програма хоч і приймає текст з пробілам, але робота алгоритму базується на шифруванні та розшифруванні тексту без них, тому для перевірки будемо використовувати текст без пробілів.
